...
WITH base AS (
    SELECT
        CASE
            ...
            -- 00_setup.sql's #death_stratum_counts INSERT -- a no-op on
            -- every other dialect and on this one, since index_date is
            -- already unique per group in the (YEAR(index_date)) set and
            -- this branch never runs for the () set.

...
SELECT
    ...
    x.from_event,
    x.to_event,
    CASE WHEN x.n_patients_with_pair > 0 AND x.n_patients_with_pair <= @min_cell_count THEN -@min_cell_count ELSE x.n_patients_with_pair END AS n_patients_with_pair,
